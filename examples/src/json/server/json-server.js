...
import { createConnection, TextDocuments, ProposedFeatures } from 'vscode-languageserver/lib/node/main.js';
...
export class JsonServer {
    ...
    async resolveSchema(url) {
        ...
        try {
            ...
            const err = error;
            return Promise.reject(err.responseText !== undefined || requestLight.getErrorStatusDescription(err.status) || err.toString());
        }
    }
