...
const sleepOne = (milliseconds) => {
    ...
    console.log('Hello swap editors!');
        ...
        const appConfig44 = wrapper44Config.wrapperConfig.editorAppConfig;
...
export const runAdvancedExample = async () => {
    try {
        ...
        try {
            ...
            console.log(`Catched expected connection error: ${e.message}`);
        }
...
//# sourceMappingURL=wrapperAdvanced.js.map